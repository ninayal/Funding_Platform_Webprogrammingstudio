...
const giftTypes=[
  {
    ...
    copy:"Create a meaningful gift while Làng & Co. directs the contribution across verified organizations, approved individuals, and priority causes.",
  ...
  },
  {
    ...
    copy:"Choose a specific cause yourself, make the donation in someone special's honour, and send them a meaningful note.",
    action:"Choose this option →"
  }
];
